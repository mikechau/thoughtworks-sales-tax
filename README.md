...
I am fairly new to programming and to test driven development in general. This problem was quite challenging as a beginner because having just learned Ruby about 3 months ago and do not have a formal background with object oriented programming. This was a great exercise for me personally, as I think it helped me better understand OOP and get a really good feel for TDD.  

For me, with test driven development, it is almost going backwards in a way (thinking of tests to write first then coding). So it is a bit of a shift in gears from just coding (going forwards) to test driven development (going backwards).  

I really do enjoy programming though, and definitely wish I got into it more when I was in school. Any feedback or books to read up on would be greatly appreciated. Thank you for your time!  
